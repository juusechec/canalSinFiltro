...
export class VideoCreateWidget extends Component {
  ...
  render() {
    const cls = `${styles.form} ${(this.props.showAddVideo ? styles.appear : '')}`;
    return (
      <div>
        <a className={styles['add-post-button']} href="#" onClick={this.props.toggleAddVideo}><FormattedMessage id="addPost" /></a>
        <div className={cls}>
